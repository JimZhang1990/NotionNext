...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Oli', // 
  BIO: process.env.NEXT_PUBLIC_BIO || ' ', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://oli-investing.cc', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'TMT Investing, Random thoughts', // 网站关键词 英文逗号隔开
