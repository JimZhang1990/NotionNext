...
const BLOG = {
  NOTION_PAGE_ID:
    ...
    '2239d343c1d280fc82ddc2e06665cf8d',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Oli the Cat', // 
  BIO: process.env.NEXT_PUBLIC_BIO || ' ', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || ' ', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Investing, Random thoughts', // 网站关键词 英文逗号隔开
...
module.exports = BLOG
  ...
  // 谷歌广告
 // ADSENSE_GOOGLE_ID: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_ID || 'pub-5183873159792097', // 谷歌广告ID e.g ca-pub-xxxxxxxxxxxxxxxx
  ...
  // ADSENSE_GOOGLE_SLOT_IN_ARTICLE: process.env.NEXT_PUBLIC_ADSENSE_GOOGLE_SLOT_IN_ARTICLE || '6348427053', // Google AdScene>广告>按单元广告>新建文章内嵌广告 粘贴html代码中的data-ad-slot值
